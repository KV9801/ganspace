...
class StyleGAN2(BaseModel):
    ...
    def download_checkpoint(self, outfile):
        checkpoints = {
            'pizza': 'https://drive.google.com/uc?export=download&id=1Chk0SSmDKaUPgeG3Inu1vMLUAWla-wYS',
    ...
    def load_model(self):
        ...
        self.model = stylegan2.Generator(self.resolution, 512, 8, 1).to(self.device)
